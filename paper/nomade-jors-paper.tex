...
\caption{Educational analytics outputs. \textbf{Top left} (\texttt{nomade edu explain 1104}): Job explanation
with proficiency scores and recommendations. \textbf{Top right} (\texttt{nomade edu trajectory alice}): User trajectory
tracking improvement over 173 jobs. \textbf{Bottom} (\texttt{nomade edu report cs101}): Group report for a course
