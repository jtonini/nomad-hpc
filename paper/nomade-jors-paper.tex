...
\begin{figure}[htbp]
\centering
\includegraphics[height=6.5cm]{figures/edu_explain.png}\hspace{0.5cm}\includegraphics[height=6.5cm]{figures/edu_trajectory.png}

\vspace{0.3cm}

\includegraphics[height=6.5cm]{figures/edu_report.png}

\vspace{0.2cm}

{\small \texttt{nomade edu explain 1104} \hspace{1cm} \texttt{nomade edu trajectory alice} \hspace{1cm} \texttt{nomade edu report cs101}}

\caption{Educational analytics outputs. \textbf{Top left}: Job explanation
with proficiency scores and recommendations. \textbf{Top right}: User trajectory
tracking improvement over 173 jobs. \textbf{Bottom}: Group report for a course
