...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{figures/edu_explain.png}
\caption{Output of \texttt{nomade edu explain 1104} showing proficiency scores
across four dimensions, actionable recommendations for improving CPU efficiency,
and the user's progress trend over their last 30 jobs. Color-coded bars and
trend indicators provide at-a-glance feedback suitable for both students and
instructors.}
\label{fig:edu_explain}
\end{figure}
