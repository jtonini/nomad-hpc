                ...
                <div>
                    <header className="header">
                        ...
                        <div className="header-right">
                            <button className="theme-toggle" onClick={() => { document.body.classList.toggle("light-theme"); localStorage.setItem("nomade-theme", document.body.classList.contains("light-theme") ? "light" : "dark"); }}>🌓 Theme</button>
